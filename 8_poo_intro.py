...
# Cuando hablamos de POO estamos hablando de un paradigma de programación donde debemos resolver la problemática a partir de clases y objetos. 
# Si recordamos las primeras clases cuando hablamos de tipos de datos dijimos que todos los datos en Python eran tratados como objetos.
# En Python cada objeto tiene una identidad, un tipo y un valor. 

# La identidad de objeto nunca cambia una vez es creada es por esto que al devolver un objeto independientemente del tipo veíamos la dirección del objeto en memoria. 

# El tipo de un objeto es inmutable. La función “type()” nos mostraba el tipo de un objeto (que es un objeto en sí mismo). 
# El tipo de un objeto determina las operaciones o acciones que admite el objeto (por ejemplo, agregar o remover elementos de una lista) 
# Y también define los valores posibles para los objetos de ese tipo (si trabajamos con un input entonces trabajaremos con strings como dato por defecto). 
...
# En POO las características son variables, las cuales llamaremos atributos y a las acciones las llamaremos métodos. 


#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Clase --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Es un modelo, una especie de plantilla o prototipo que se utiliza para crear instancias individuales del mismo tipo de objeto.
...
# Como ejemplo vamos a implementar las clases del siguiente diagrama: https://bit.ly/30Zuo31
# Tomaremos la clase "Figura" como clase base, la clase "Poligono" como clase derivada de primer nivel y la clase "Cuadrilatero" como clase derivada de segundo nivel. 
...
# Poligono se deriva de Figura , y Cuadrilatero se deriva de Poligono por lo que Cuadrilatero tendra los métodos y atributos tanto de las clase Poligono como de la clase Figura. 
# Si en la clase Poligono alguno de las métodos de Figura es redefinido Cuadrilatero heredara el método redefinido.
